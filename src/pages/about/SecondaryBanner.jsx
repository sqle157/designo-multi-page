function SecondaryBanner() {
	return (
		<section className='secondary-banner grid'>
			<div className='secondary-banner__img'></div>
			<div className='secondary-banner__intro'>
				<h2 className='text-primary-peach'>World-class talent</h2>
				<p>
					We are a crew of strategists, problem-solvers, and technologists. Every design is
					thoughtfully crafted from concept to launch, ensuring success in its given market. We
				...
				<p>
					...
					and prompt delivery. Clients have always been impressed with our high-quality
